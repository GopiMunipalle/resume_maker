        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-12 text-center">
            <p className="text-lg text-gray-800 mb-4">
              Need help building your perfect resume?
            </p>
            <a
